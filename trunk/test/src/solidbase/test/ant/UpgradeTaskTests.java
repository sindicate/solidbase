...
public class UpgradeTaskTests extends BuildFileTest
{
	...
	public void testUpgradeTask()
	{
		...
		Assert.assertEquals( log, "SolidBase v1.5.x(C) 2006-2009 Rene M. de BlooisConnecting to database...The database has no version yet.Opening patchfile 'file:/.../testpatch-multiconnections.sql'    Encoding is 'ISO-8859-1'Patching to \"1.0.1\"    Creating table DBVERSION.    Creating table DBVERSIONLOG.Patching \"1.0.1\" to \"1.0.2\"    Creating table USERS.    Inserting admin user.The database has been patched.Current database version is \"1.0.2\"." );
	}
