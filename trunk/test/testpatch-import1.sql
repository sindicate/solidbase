...
IMPORT CSV SEPARATED BY ; PREPEND LINENUMBER INTO TEMP2
"1"; "2"; "3"
"1"; "2"; "3"
"1"; "2"; "3"
GO
...
CREATE TABLE TEMP3 ( TEMP1 VARCHAR, TEMP2 VARCHAR )
GO

IMPORT CSV SEPARATED BY |
INTO TEMP3 ( TEMP2     ,     TEMP1 )
1|2
1|2
GO

PRINT SELECT TEMP1 || TEMP2 FROM TEMP3
GO
