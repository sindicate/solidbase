...
EXPORT JSON FILE "output/export21.json"
FROM SELECT * FROM TEMP1;

EXPORT JSON DATE AS TIMESTAMP FILE "output/export22.json"
BINARY FILE "output/export22.bin"
FROM SELECT * FROM TEMP1;
--* // COLUMN PICTURE TO BINARY FILE "export22.picture.bin"
--* // COLUMN TEXT2 TO TEXT FILE "export22.text2.txt"

EXPORT JSON FILE "output/export23.json"
FROM SELECT * FROM TEMP1;
