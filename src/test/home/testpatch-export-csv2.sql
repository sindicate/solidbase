...
EXPORT CSV WITH HEADER FILE "output/export21.csv" ENCODING "UTF-8"
FROM SELECT * FROM TEMP1;

EXPORT CSV DATE AS TIMESTAMP FILE "output/export22.csv" ENCODING "UTF-8" FROM
SELECT * FROM TEMP1;

EXPORT CSV FILE "output/export23.csv" ENCODING "UTF-8"FROM
SELECT * FROM TEMP1;
